...
(function() {
	...
	class Carousel {
		...
		constructor({carouselID, itemsContainerClass, itemElemsArray, numItems, breakpoint1, breakpoint2}) {
		...
		async _shiftLeft(isFast) {
			...
			this._itemsContainerElem.removeChild(this._itemsContainerElem.querySelector('.testimonial-card:last-child'));
			...
			for (let i = 0; i < rightmostDist; ++i) { this._itemElemsArray[i].className = 'testimonial-card'; }
		...
		async _shiftRight(isFast) {
			...
			this._itemsContainerElem.removeChild(this._itemsContainerElem.querySelector('.testimonial-card:first-child'));
			this._itemsContainerElem.insertAdjacentElement('beforeend', this._itemElemsArray[this._numItems - 1]);

			for (let i = rightmostDist; i > 0; --i) { this._itemElemsArray[i].className = 'testimonial-card'; }
